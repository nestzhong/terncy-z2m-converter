...
// Terncy/Xiaoyan MT001, tunable white (CCT) light.
//
...
export default {
    zigbeeModel: ["MT001"],
    fingerprint: [{modelID: "MT001", manufacturerName: "Xiaoyan"}],
    model: "MT001",
    vendor: "Terncy",
    description: "Tunable white (CCT) light",
    ...
    configure: async (device, coordinatorEndpoint) => {
        ...
        try {
            ...
            console.warn(`MT001: skipped reporting setup: ${error.message}`);
        }
    },
};
