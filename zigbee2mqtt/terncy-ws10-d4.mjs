...
// Terncy/Xiaoyan TERNCY-WS10-D4, 4-gang wall switch.
//
// Derived from gateway firmware reverse engineering (node-struct):
//   modelID: TERNCY-WS10-D4
...
// The WS10 family additionally exposes 0xfccc attrs 0x22
// (numberOfTimeoutControls) and 0x28 (turnOffDelayMs); these are not exposed
// yet because their App-level meaning is unverified.
// This model has not yet been re-verified on a physical WS10-D4.
...
// Every endpoint of the WS10-D4 carries an OnOff server cluster (relay).
const RELAY_ENDPOINTS = {l1: 1, l2: 2, l3: 3, l4: 4};
...
export default {
    zigbeeModel: ["TERNCY-WS10-D4"],
    fingerprint: [{modelID: "TERNCY-WS10-D4", manufacturerName: "Xiaoyan"}],
    model: "TERNCY-WS10-D4",
    vendor: "Terncy",
    description: "4-gang wall switch",
    extend: [
    ...
    configure: async (device, coordinatorEndpoint) => {
        for (const ID of Object.values(RELAY_ENDPOINTS)) {
            ...
            try {
                ...
                console.warn(`TERNCY-WS10-D4: skipped reporting setup for endpoint ${ID}: ${error.message}`);
            }
        }
    },
};
