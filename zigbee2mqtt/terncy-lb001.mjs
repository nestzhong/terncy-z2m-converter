...
// Terncy/Xiaoyan LB001, tunable white (CCT) light bulb.
//
...
export default {
    zigbeeModel: ["LB001"],
    fingerprint: [{modelID: "LB001", manufacturerName: "Xiaoyan"}],
    model: "LB001",
    vendor: "Terncy",
    description: "Tunable white (CCT) light bulb",
    ...
    configure: async (device, coordinatorEndpoint) => {
        ...
        try {
            ...
            console.warn(`LB001: skipped reporting setup: ${error.message}`);
        }
    },
};
