...
// Terncy/Xiaoyan TERNCY-WS04-D2, 2-gang wall switch.
//
// Derived from gateway firmware reverse engineering (node-struct):
//   modelID: TERNCY-WS04-D2
...
// This model has not yet been re-verified on a physical WS04-D2.
...
export default {
    zigbeeModel: ["TERNCY-WS04-D2"],
    fingerprint: [{modelID: "TERNCY-WS04-D2", manufacturerName: "Xiaoyan"}],
    model: "TERNCY-WS04-D2",
    vendor: "Terncy",
    ...
    configure: async (device, coordinatorEndpoint) => {
        for (const ID of Object.values(ENDPOINTS)) {
            ...
            try {
                ...
                console.warn(`TERNCY-WS04-D2: skipped reporting setup for endpoint ${ID}: ${error.message}`);
            }
        }
    },
};
